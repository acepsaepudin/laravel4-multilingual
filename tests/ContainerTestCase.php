...
abstract class ContainerTestCase extends PHPUnit_Framework_TestCase {
    ...
    public function __get($key) {
        if ($key == 'translator') {
            return $this->app['thor.language.translator'];
        }
     ...
     * @return Mockery
     */
    protected function mockRequest($segment = 'es') {
    ...
    protected function mockConfig() {
        ...
        $config->shouldReceive('get')->with('language::available_locales')->andReturn(array('en' => 'en_US', 'es' => 'es_ES'));
